        ...
        <div class="col-md-3">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-body">
                       @include('project_categories.create')
                    </div>
                </div>
                <!-- /.box -->
            </div>
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Project Categories List</h3>
                    </div>
                    <div class="box-body ">
                           ...
                           <tbody>
                              @foreach($projectCategories as $row)
                                <tr>
                                    ...
                                    <td>
                                    <a href="{{ route('project_categories.show',$row->id) }}"  title="View Class"><i class="fa fa-eye"></i></a>
                                    <a href="{{ route('project_categories.edit',$row->id) }}"  title="Edit Class" ><i class="fa fa-pencil"></i></a>
                                    ...
                                    <form id="deleteForm-{{$row->id}}" action="{{route('project_categories.destroy',$row->id)}}" method="post">
                                      @csrf
                                      @method('DELETE')
                                    </form>
                                  </td>
