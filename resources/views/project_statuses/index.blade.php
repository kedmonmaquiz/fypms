        ...
        <div class="col-md-3">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-body">
                       @include('project_statuses.create')
                    </div>
                </div>
                <!-- /.box -->
            </div>
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Project Statues List</h3>
                    </div>
                    <div class="box-body ">
                           ...
                           <tbody>
                              @foreach($projectStatuses as $row)
                                <tr>
                                    ...
                                    <td>
                                    <a href="{{ route('project_statuses.show',$row->id) }}"  title="View Class"><i class="fa fa-eye"></i></a>
                                    <a href="{{ route('project_statuses.edit',$row->id) }}"  title="Edit Class" ><i class="fa fa-pencil"></i></a>
                                    ...
                                    <form id="deleteForm-{{$row->id}}" action="{{route('project_statuses.destroy',$row->id)}}" method="post">
                                      @csrf
                                      @method('DELETE')
                                    </form>
                                  </td>
