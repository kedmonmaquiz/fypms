                           ...
                           <tbody>
                              @foreach($departments as $row)
                                <tr>
                                    ...
                                    <td>@if($row->college) {{$row->college->abbreviation}} @else <i class="text-danger">Not Found</i> @endif</td>
                                    <td>
                                    <a href="{{ route('departments.show',$row->id) }}"  title="View Class"><i class="fa fa-eye"></i></a>
                                    <a href="{{ route('departments.edit',$row->id) }}"  title="Edit Class" ><i class="fa fa-pencil"></i></a>
